...
If there are staged changes, read the `git-commit` skill from `.github/skills/git-commit/SKILL.md` and follow it to commit.
...
Read the `git-pr-description` skill from `.github/skills/git-pr-description/SKILL.md` to generate the PR body.
