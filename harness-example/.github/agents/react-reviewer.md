---
description: Reviews React/TypeScript components for correctness and patterns — TypeScript strictness, hook rules, and prop drilling. Returns a structured findings list with pass/warning/error per category.
mode: subagent
temperature: 0.1
permission:
  edit: deny
