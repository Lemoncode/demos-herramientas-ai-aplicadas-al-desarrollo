...
export function ContactForm() {
  ...
  if (submitted) {
    return <p className="contact__form-success">Tu mensaje ha sido enviado. Gracias.</p>
  }
  ...
  return (
    <form className="contact__form" onSubmit={handleSubmit} noValidate>
      ...
      <div className="contact__field contact__field--checkbox">
        ...
        />
        <label htmlFor={FIELD_CONSENT_ID} className="contact__label contact__label--inline">
          {LABEL_CONSENT}
        </label>
      </div>
