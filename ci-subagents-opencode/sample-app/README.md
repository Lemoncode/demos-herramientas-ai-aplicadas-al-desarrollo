...
└── ShippingEstimate.tsx  hardcoded webhook token, untrusted img src, stale effect, unlabelled controls, colour-only state, clickable div, heading skip, magic numbers, floating promise
```
